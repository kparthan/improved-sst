...
fw = open('generate_dssp_assignments.sh','w')
...
while line != '':
  ...
  path = scop_path + domain_dir + domain + '.ent'
  cmd = './dssp ' + path + ' dssp-assignments/' + domain + '.dssp'
  fw.write(cmd+'\n')
...
os.system('chmod 755 generate_dssp_assignments.sh')
